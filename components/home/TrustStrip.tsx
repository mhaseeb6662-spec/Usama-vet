    ...
    <section className="px-4 max-w-7xl mx-auto py-2">
      <StaggerContainer staggerDelay={0.06} className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StaggerItem distance={10}>
          <div className="bg-emerald-50/45 border border-emerald-100/60 rounded-xl p-4 flex items-center gap-4 text-left shadow-sm hover:shadow-md hover:-translate-y-[2px] transition-all duration-200 group">
            <div className="w-10 h-10 rounded-lg bg-white text-emerald-600 flex items-center justify-center shadow-sm shrink-0 group-hover:scale-[1.05] transition-transform duration-200">
