...
export default function NewsletterSection() {
  ...
  return (
    <section className="bg-slate-100 border-t border-b border-slate-200 py-12 px-4">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="w-full max-w-md space-y-4">
          {subscribed ? (
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2 shadow-sm rounded-lg overflow-hidden">
              <input
                type="email"
