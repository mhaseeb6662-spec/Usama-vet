...
export default function Button({
  ...
  const variants = {
    ...
    secondary: "bg-teal-50 hover:bg-teal-100 text-teal-800 border border-transparent",
    outline: "border border-slate-300 bg-white hover:bg-slate-50 text-slate-700",
    text: "text-emerald-600 hover:text-emerald-700 hover:underline p-0 focus:ring-0 focus:ring-offset-0",
  };
