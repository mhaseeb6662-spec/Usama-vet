      ...
      <section className="max-w-6xl mx-auto px-4 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
            <h3 className="text-slate-900 font-bold text-sm uppercase tracking-wider border-b border-slate-100 pb-2 flex items-center gap-2">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <span className="block font-bold text-slate-700">Call/SMS Support</span>
                  <a href={`tel:${BUSINESS_CONFIG.contact.phone}`} className="text-emerald-700 font-semibold hover:underline block mt-0.5">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <span className="block font-bold text-slate-700">WhatsApp Helpline</span>
                  <a
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <span className="block font-bold text-slate-700">Official Email</span>
                  <a href={`mailto:${BUSINESS_CONFIG.contact.email}`} className="text-slate-650 hover:text-emerald-600 hover:underline block mt-0.5">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <span className="block font-bold text-slate-700">Store & Clinic Address</span>
                  <span className="text-slate-500 block leading-relaxed mt-0.5">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <span className="block font-bold text-slate-700">Operating Hours</span>
                  <div className="text-slate-500 mt-0.5 space-y-0.5">
                    {BUSINESS_CONFIG.hours.map((h, index) => (
                      <div key={index}>
                        <span className="font-semibold text-slate-650">{h.days}:</span> {h.time}
                      </div>
                    ))}
                  </div>
                </div>
