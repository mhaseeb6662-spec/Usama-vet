export const BUSINESS_CONFIG = {
  name: "Usama Vet Care & Agri Services",
  shortName: "Usama Vet",
  ...
  features: [
    {
      ...
      description: "Directly sourced from GMP-certified international and local pharmaceutical brands.",
    },
    {
      title: "Trusted Veterinary Sourcing",
      description: "Every product is verified by qualified veterinary professionals for efficacy and safety.",
    },
    {
      title: "Nationwide Safe Delivery",
      description: "Secure, temperature-controlled logistics to preserve medicine potency across the country.",
    },
    {
      title: "Dedicated Customer Support",
      description: "Direct phone and WhatsApp helpline with product guidance for livestock & pets.",
    },
  ],
};
